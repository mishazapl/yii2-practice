...
<a href="/admin/article/create" id="create-article"><div class="btn btn-success">Добавить статью</div></a>
...
<table class="table table-bordered">
    ...
    <tr>
        <th scope="row"><?= $article->user->login ?></th>
        <td><?= $article->header ?></td>
        <td><?= $article->small_text ?></td>
